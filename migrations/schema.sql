-- Sports Camp Management System Database Schema
-- MySQL 5.7+ compatible
-- All dates stored as Jalali (Shamsi) format strings (YYYY-MM-DD)
...
-- Coach-Time Slot many-to-many relationship
...
-- Rents table (linked to expenses)
